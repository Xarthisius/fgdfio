module gdf_datasets
  ...
  interface write_dataset
     module procedure write_dataset_any_dim1
     module procedure write_dataset_any_dim2
     module procedure write_dataset_any_dim3
  end interface write_dataset

contains

   subroutine write_dataset_any_dim1(place, dname, data, plist_id)
    use hdf5
    ...
    integer(kind=4), parameter :: dimensionality=1
    integer(kind=8), parameter, dimension(dimensionality)      :: offset=(/ 0 /) !< the array index to start writing at (zero indexed)
    integer(kind=8), dimension(dimensionality)      :: count, data_dims             !< the number of points to write.
  ...
  end subroutine write_dataset_any_dim1



  subroutine write_dataset_any_dim2(place, dname, data, plist_id)
    use hdf5
    ...
    integer(kind=8), parameter, dimension(dimensionality)      :: offset=(/ 0, 0 /) !< the array index to start writing at (zero indexed)
    integer(kind=8), dimension(dimensionality)      :: count, data_dims             !< the number of points to write.
  ...
  end subroutine write_dataset_any_dim2



  subroutine write_dataset_any_dim3(place, dname, data, plist_id)
    use hdf5
  ...
  end subroutine write_dataset_any_dim3
