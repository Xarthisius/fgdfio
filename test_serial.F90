...
program test
   ...
   integer(HID_T)                                :: sp_g_id          !< sp list identifiers
   ...
   call write_sac_dataset(doml_g_id, "test", domain_dimensions, domain_dimensions, data, plist_id)
